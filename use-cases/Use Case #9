# USE CASE: 9 All the cities in a continent organised by largest population to smallest.

## CHARACTERISTIC INFORMATION

### Goal in Context

We want to **produce a report on all the cities in a continent organised by largest population to smallest**
...
Database contains city data, country data and has city population field filled.
